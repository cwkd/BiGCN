...
def train_TreeBERT(treeDic, x_test, x_train, TDdroprate, BUdroprate, lr, weight_decay, patience, n_epochs,
    ...
    try:
        for epoch in range(n_epochs):
            ...
            if not os.path.exists(save_dir):
                os.makedirs(save_dir)
            save_path = os.path.join(save_dir, f'final_{pooling}BERT_f{fold}_i{iter}_e{epoch:05d}_l{loss:.5f}.pt')
            th.save(checkpoint, save_path)
        ...
        if not os.path.exists(save_dir):
            os.makedirs(save_dir)
        save_path = os.path.join(save_dir, f'interrupt_{pooling}BERT_f{fold}_i{iter}_e{epoch:05d}_last.pt')
        th.save(checkpoint, save_path)
    # except:
...
if __name__ == '__main__':
    ...
    for iter in range(iterations):
        if datasetname != 'PHEME':
            ...
            train_losses, val_losses, train_accs, val_accs0, accs0, F1_0, F2_0, F3_0, F4_0 = train_TreeBERT(treeDic,
                                                                                                            fold0_x_test,
                                                                                                            fold0_x_train,
                                                                                                            ...
                                                                                                            fold=0,
                                                                                                            device=device)
            train_losses, val_losses, train_accs, val_accs1, accs1, F1_1, F2_1, F3_1, F4_1 = train_TreeBERT(treeDic,
                                                                                                            fold1_x_test,
                                                                                                            fold1_x_train,
                                                                                                            ...
                                                                                                            fold=1,
                                                                                                            device=device)
            train_losses, val_losses, train_accs, val_accs2, accs2, F1_2, F2_2, F3_2, F4_2 = train_TreeBERT(treeDic,
                                                                                                            fold2_x_test,
                                                                                                            fold2_x_train,
                                                                                                            TDdroprate, BUdroprate, lr,
                                                                                                            weight_decay,
                                                                                                            ...
                                                                                                            fold=2,
                                                                                                            device=device)
            train_losses, val_losses, train_accs, val_accs3, accs3, F1_3, F2_3, F3_3, F4_3 = train_TreeBERT(treeDic,
                                                                                                            fold3_x_test,
                                                                                                            fold3_x_train,
                                                                                                            TDdroprate, BUdroprate, lr,
                                                                                                            weight_decay,
                                                                                                            ...
                                                                                                            fold=3,
                                                                                                            device=device)
            train_losses, val_losses, train_accs, val_accs4, accs4, F1_4, F2_4, F3_4, F4_4 = train_TreeBERT(treeDic,
                                                                                                            fold4_x_test,
                                                                                                            fold4_x_train,
                                                                                                            TDdroprate, BUdroprate, lr,
                                                                                                            weight_decay,
